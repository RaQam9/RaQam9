// ==========================================================
// الملف: app.js (النسخة النهائية والمضمونة)
// ==========================================================
...
async function initializeNewsPage() {
    ...
    try {
        ...
        newsArticlesCache = data;
        renderArticleCards(newsArticlesCache);
    } catch (err) {
