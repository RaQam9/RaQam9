...
document.addEventListener('DOMContentLoaded', () => {
    ...
    initializeProfilePageListeners(); // <-- تم التأكيد على وجودها هنا
});
...
function initializeAuth() {
    ...
    signupForm.addEventListener('submit', async (e) => {
        ...
        const { data, error } = await supabaseClient.auth.signUp({ email, password, options: { data: { username: username } } });
